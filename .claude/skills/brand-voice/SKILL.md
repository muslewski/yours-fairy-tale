---
name: brand-voice
description: Use when writing or editing any user-facing copy for Yours Fairy Tale — headlines, subheads, CTAs, button labels, microcopy, errors, empty states, emails, notifications, or marketing text.
---

# Yours Fairy Tale — Brand Voice
...
1. **Warm and sincere.** Write like a kind friend, not an ad.
2. **The child is the hero; the parent is the audience.** Speak to the grown-up ("your child", "their story"), and keep the child at the center of the wonder.
3. **Concrete over hype.** Specific, sensory details ("their name, their curls, their favorite animal") always beat abstract claims ("a magical journey").
4. **Calm confidence.** We rarely raise our voice. A period does more than an exclamation point.
...
| Sentence length | Short and readable. One idea per sentence. |

## Forbidden

- **Comic-book SFX:** "Pow!", "Kapow!", "Boom!", "Zap!", "Wham!", all-caps shouting. The *visual* style can be bright and playful; the *words* stay calm and heartfelt. Never let loud design pull the copy loud.
- **Jokey labels** for the child: "tiny legend", "little legend", "mini-me".
- **Hype clichés:** "magical journey", "unleash imagination", "world of imagination", "spark their imagination", "revolutionary", "game-changing", "epic", "awesome".
...
**Off-brand (loud, em-dash, Title Case, SFX):**
...
| British spelling ("colour", "favourite") | American ("color", "favorite"). |
