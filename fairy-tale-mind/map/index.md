...
<!-- mind:counts zones=13 stale=2 debt=6 -->
# Map Index
...
| [[checkout]] | active | ⚠ stale | Stripe checkout integration — mock UI simulation + real Checkout Session route + webhook that creates checkout-gated accounts and orders. |
