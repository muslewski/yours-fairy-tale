...
<!-- mind:counts zones=17 stale=5 debt=11 -->
# Map Index
...
| [[series]] | active | ⚠ stale | The Series subpage and its REAL waitlist — signups persist to the Payload `waitlist` collection via /api/waitlist and get a non-fatal Resend thank-you. |
